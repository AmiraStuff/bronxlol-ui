        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                Items["MainFrame"] = Instances:Create("Frame", {
                    ...
                    Position = UDim2New(0, math.max(10, ViewportWidth / 2 - WindowWidth / 2), 0, math.max(10, ViewportHeight / 2 - WindowHeight / 2)),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Visible = false,
                    ClipsDescendants = true,
                                        ZIndex = 1,
                ...
                ResizeButton = Items["MainFrame"]:MakeResizeable(
                    Vector2New(WindowWidth * 0.6, WindowHeight * 0.6), 
                ...
                Items["Pages"] = Instances:Create("Frame", {
                    ...
                    Position = UDim2New(0, 8, 0, 48),
                                        ZIndex = 2,
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(0, SidebarWidth, 1, -56),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })
                ...
                Items["Content"] = Instances:Create("Frame", {
                    ...
                    Name = "\0",
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, SidebarWidth + 16, 0, 48),
                                        ZIndex = 2,
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(1, -(SidebarWidth + 24), 1, -56),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })
                ...
                Instances:Create("Frame", {
                    Parent = Items["MainFrame"].Instance,
                    Name = "\0",
                    Position = UDim2New(0, SidebarWidth + 15, 0, 40),
                    BorderColor3 = FromRGB(0, 0, 0),
            ...
            local OldSize = {X = WindowWidth, Y = WindowHeight}
            ...
            function Window:Minimize(Bool)
                ...
                if IsMinimized then
                    OldSize = {X = Items["MainFrame"].Instance.AbsoluteSize.X, Y = Items["MainFrame"].Instance.AbsoluteSize.Y}
